...
export default function OcurrenciaModelo() {
  ...
  const categoriasModelosSelector = [
    ...
    {modelo:"Sentimientos", categorias: ["Amor","Agrado","Agotamiento","Alegría", "Altivez","Apatía","Aversión", "Calma","Certeza","Compasión","Desagrado","Deseo","Duda","Dolor","Entusiasmo","Frustración","Humillación","Placer", "Odio","Tensión","Valor","Vigor", "Satisfacción" ]},
